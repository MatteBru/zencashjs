...
function privKeyToWIF(privKey) {
  ...
  var wif = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : zconfig.testnet.wif;
...
function pubKeyToAddr(pubKey) {
  var pubKeyHash = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : zconfig.testnet.pubKeyHash;
...
function multiSigRSToAddress(redeemScript) {
  var scriptHash = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : zconfig.testnet.scriptHash;
